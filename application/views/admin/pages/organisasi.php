                                                ...
                                                <?php foreach ($organisasi as $row) { ?>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            onclick=    "EditOrganisasi('<?= $row->id; ?>')">
                                                            <i class="fa fa-edit"></i>
                                                        </button> -->
                                                                <button class="btn btn-md btn-danger" onclick="DeleteOrganisasi('<?= $row->id; ?>')">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <img src="" alt="" id="img_update" style="width: 50%;height: 50%;">
                            </div>
                            <div class="form-group">
                                <label for="">File Upload</label>
                                <input type="file" name="file_image" id="file_image" class="form-control">
            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="col-md-12">
                        <button class="btn btn-md btn-warning button-prevent" onclick="simpan_data_organisasi()">
                            <i class="fa fa-save hide-text"></i>
