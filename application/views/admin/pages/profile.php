...
<div class="br-mainpanel">
    ...
    <div class="br-pagetitle">
        ...
        <div>
            <h4>Informasi Data Profile Musem</h4>
            <p class="mg-b-0">
                Informasi Data Profile Lengkap Museum.
            </p>
        </div>
    </div><!-- d-flex -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="button-group">
                                    <button class="btn btn-md btn-primary" onclick="add_profile()">
                        ...
                        <div class="row pt-5">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table id="tbl_profile" class="table display table-hover nowrap"
                                        style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>#action</th>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="input-group">
                                                        <button class="btn btn-md btn-warning"
                                                            onclick="EditShowProfile('<?= $profile->id; ?>')">
                                                ...
                                                <td>
                                                    <div class="media mg-t-20 mg-b-0">
                                                        <img src="<?= base_url() ?>public/upload/profile/<?= $profile->file_img; ?>"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-warning">
                <h5 class="modal-title text-white" id="my-modal-title">Updae Data Profile</h5>
                <button class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <img src="" alt="" id="img_edit" style="width: 50%;height: 50%;">
                            </div>
                            <div class="form-group">
                                <label for="">File Upload (Jika Data Anda Ingin Diperbaharui )</label>
            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="col-md-12">
                        <button class="btn btn-md btn-warning button-prevent" onclick="UpdateDataProfile()">
                            <i class="fa fa-edit hide-text"></i>
