                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="input-group">
                                                                <button class="btn btn-danger btn-md" onclick="DeleteVideo('<?= $row->id; ?>', '<?= $row->tanggal; ?>', '<?= $row->judul; ?>')">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="">File URL (Embed Youtube)</label>
                                <textarea name="file_url" id="file_url" class="form-control" cols="2" rows="2"></textarea>
                            </div>
                            <div class="form-group">
